...
const Attributes = () => {
  ...
  const handleSubmit = async () => {
    ...
    const savedVisions = [
      localStorage.getItem("vision1"),
      localStorage.getItem("vision2"),
      localStorage.getItem("vision3"),
    ];
    const savedGoals = [
      localStorage.getItem("goal1"),
      localStorage.getItem("goal2"),
      localStorage.getItem("goal3"),
      localStorage.getItem("goal4"),
    ];
    const savedAttributes = [
      localStorage.getItem("attribute1"),
      localStorage.getItem("attribute2"),
      localStorage.getItem("attribute3"),
      localStorage.getItem("attribute4"),
    ];
    ...
    >
      ...
      <animated.div style={{ ...contentProps, padding: "20px" }}>
        ...
        <p style={{ fontSize: "1.2em" }}>
          These are ways you want to change your behaviors, possibly to help you
          reach your goals and visions.
        </p>
        <p style={{ fontSize: "1.2em" }}>Give me 2-4.</p>
        Examples:
